...
function showData(dataArray) {
  ...
  // Aquí modifiqué el codigo para que itere en los estudiantes del dataArray, ya que de otra manera me daba error
...
// Hago fetch para obtener los datos del json
fetch(DATA_URL)
  // Convierto la respuesta a un json válido
  .then(respuesta => respuesta.json())
  // Uso la función showData pasándole como argumento la respuesta del fetch
  .then(respuesta => {
    showData(respuesta);
  }
);